...
{   "NKD_4": "dd.dd", "NKD_naziv": "točan naziv iz NKD PDF tablice", "KPD_6": "dd.dd.dd",   "Naziv_proizvoda": "točan naziv iz KPD tablice",   "Razlog_odabira": "1–3 rečenice objašnjenja na temelju dokumenata",   "Poruka": null,   "alternativne": [     {       "KPD_6": "xx.xx.xx",       "Naziv": "...",       "kratko_zašto": "kratko objašnjenje"     }   ] } 
...
Ne izmišljaj šifre ako ne postoje, nego ponudi šifre iz istog NKD podrazreda koje se slazu s KPD_6"
